      ...
      <div className="container-wide">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          ...
          <FadeIn direction="left">
            <div className="bg-brand-blue rounded-3xl overflow-hidden h-full flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                {employerBenefits.map((b) => (
                  <li key={b} className="flex items-start gap-3 text-blue-100 text-sm">
                    <svg className="w-5 h-5 text-brand-gold shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
          ...
          <FadeIn direction="right">
            <div className="bg-white border-2 border-brand-gold rounded-3xl overflow-hidden h-full flex flex-col">
              <div className="relative h-48 lg:h-56">
                <Image
              ...
              <div className="p-8 lg:p-10 pt-6 flex flex-col flex-1">
              <h3 className="text-2xl font-bold text-brand-blue mb-3">For Students</h3>
              <p className="text-neutral-700 mb-6 leading-relaxed">
                Gain real work experience, earn a paycheck, and launch your career while still in school.
              </p>
              <ul className="space-y-3 mb-8 flex-1">
                {studentBenefits.map((b) => (
                  <li key={b} className="flex items-start gap-3 text-neutral-700 text-sm">
                    <svg className="w-5 h-5 text-brand-gold shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" />
                    </svg>
                    {b}
