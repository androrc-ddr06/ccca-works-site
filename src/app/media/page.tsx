  ...
  return (
    <>
          ...
          <FadeIn>
            <div className="relative aspect-[16/9] sm:aspect-[2.4/1] rounded-3xl overflow-hidden shadow-[var(--shadow-card)]">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 lg:p-10">
                <p className="text-sm font-semibold uppercase tracking-widest text-brand-gold mb-2">
                  Student Voices
                </p>
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-wide">
          <FadeIn>
            <div className="bg-brand-blue rounded-3xl p-10 lg:p-14 text-center text-white">
              ...
              <Link
                href="/documents"
                className="inline-flex items-center gap-2 bg-brand-gold hover:bg-brand-gold-dark text-white font-semibold px-8 py-3 rounded-xl transition-colors duration-200"
              >
                View All Documents
